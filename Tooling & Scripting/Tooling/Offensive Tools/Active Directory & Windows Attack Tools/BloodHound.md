...
tags: [tree/tooling, cyber/tooling/offensive/ad/bloodhound, type/tool, level/root]
...
- **Crook:** Why is modelling AD as a graph of edges more powerful than reading group memberships?
- **Operator:** After collecting, what two steps turn the graph into an attack plan?
- **Root:** Explain why the "shortest path" isn't always the easiest, contrasting a session-dependent edge with an ACL edge.
