...
tags: [tree/tooling, cyber/tooling/offensive/web/zap, type/tool, level/operator]
...
- **Crook:** What is the difference between a passive and an active web scan?
- **Operator:** Your CI must gate on web risks without attacking the app. Which ZAP mode do you wire in, and what will it necessarily miss?
- **Root:** Explain why an automated High finding still requires manual confirmation, and how you'd verify it safely.
