...
title: "Kismet"
aliases: ["kismet"]
tags: [tree/tooling, cyber/tooling/offensive/wireless/kismet, type/tool, level/operator]
...
- **Crook:** Why do you run Kismet *before* aircrack-ng, and why is it invisible on the air?
- **Operator:** What does Kismet show you about an environment, and how does it double as a wireless IDS?
- **Root:** Explain how probe requests fingerprint a device/person, and why that's both an offensive and a privacy concern.
