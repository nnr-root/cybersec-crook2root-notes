...
tags: [tree/tooling, cyber/tooling/offensive/wireless/hcxtools, type/tool, level/root]
...
- **Crook:** How does the PMKID attack improve on the aircrack handshake method?
- **Operator:** Walk the hcxdumptool → hcxpcapngtool → hashcat flow, and say what `-m 22000` unifies.
- **Root:** Explain why an AP might yield no PMKID, what you do then, and why a strong PSK defeats both methods.
