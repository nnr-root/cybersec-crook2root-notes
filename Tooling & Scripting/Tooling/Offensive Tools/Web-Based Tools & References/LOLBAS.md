...
tags: [tree/tooling, cyber/tooling/offensive/web-tools/lolbas, type/tool, level/operator]
...
- **Crook:** Why do attackers abuse built-in Windows binaries instead of uploading their own tools?
- **Operator:** You need to download a payload but `.exe`s are blocked. Which LOLBin do you look up, and what's the command?
- **Root:** Explain why application allow-listing can't stop LOLBins, and what detection approach does.
