...
tags: [tree/tooling, cyber/tooling/programming/bash, type/concept, level/operator]
...
- **Crook:** What is Bash actually good for, and when should you stop using it?
- **Operator:** Write the safe-script preamble and explain what `set -Eeuo pipefail` and quoting buy you.
- **Root:** Show how `for f in $(ls)` and `eval` are the same class of bug, and how it becomes command injection.
